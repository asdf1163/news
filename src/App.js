...
export default function App() {
  ...
  React.useEffect(() => {
    instance.get('/search?show-elements=image&api-key=86069387-0efe-47f5-a62d-bc65c5e9e7db&id=sport' + {}).then((response) => {
  ...
  return (
    <div className="App">
      ...
      <div className="menu">
        {Kategorie.map((option) => (<Header key={option.id} id={option.id} title={option.name} img={option.img} />))}
      </div>
